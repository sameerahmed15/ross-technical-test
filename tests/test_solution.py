...
class TestFlipSort(unittest.TestCase):
    ...
    def test_partial_flip(self):
        ...
        self.assertEqual(partial_flip_sort.partial_flip([3,2,4,1], 1), [3,2,4,1])
        self.assertEqual(partial_flip_sort.partial_flip([3,2,4,1], 2), [2,3,4,1])
    ...
    def test_sorting(self):
        ...
        self.assertEqual(partial_flip_sort.sorting([4,2,3,5,1,6]), [6,6,4,5,2,4,1,3,2,2])
        self.assertEqual(partial_flip_sort.sorting([3,1,2]), [1,3,1,2])
